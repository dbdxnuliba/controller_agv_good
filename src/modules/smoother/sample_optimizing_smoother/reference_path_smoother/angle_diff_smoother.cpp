...
bool AngleDiffSmoother::smooth(PathOptimizationNS::ReferencePath *reference_path,
    ...
    weights.push_back(mp_configs->FLAGS_frenet_angle_diff_weight); //curvature weight
    weights.push_back(mp_configs->FLAGS_frenet_angle_diff_diff_weight); //curvature rate weight
    weights.push_back(0.01); //distance to boundary weight
    weights.push_back(mp_configs->FLAGS_frenet_deviation_weight); //deviation weight
