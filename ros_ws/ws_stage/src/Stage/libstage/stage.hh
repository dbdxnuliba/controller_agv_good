...
public:
    ...
    */
    ...
    {
        active_energy.insert(m);
    }
    void DisableEnergy(Model *m)
    {
        active_energy.erase(m);
    }
...
public:
    ...
    public:
        ...
        cb_t(world_callback_t cb, void *arg) : callback(NULL), arg(arg)
        {
            (void)cb;
        }
